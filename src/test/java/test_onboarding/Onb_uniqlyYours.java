 ...
 * Plan Details: Male<< Uniquely yours << more than 100 pounds to lose<< Current date<<First week - yes
 * Verification: 1) User is able to complete on-boarding and land in Journal Page
------------------------------------------------------*/
public class Onb_uniqlyYours extends baseClass {
	signInPage signInPg;
	...
	public void onb_newUser_chooseNsPlanListPage() {
		...
		firstWeekStagePg = chooseNsPlanListPg.choosePlan(chooseNsPlanListPg.getUniqYrs());
		System.out.println("==================================================================================");
